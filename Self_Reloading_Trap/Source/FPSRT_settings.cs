...
namespace FPSRT
{
    ...
    public class FPSRT_settings : ModBase
    {
        ...
        public override void DefsLoaded()
        {
            ...
            armorpenetrate = Settings.GetHandle<float>("armorpenetrate", "armor penetration Ratio to original. min : 0, max : 3",
                "hello", 1f, Validators.FloatRangeValidator(0f, 3f));
            
            traparmingtime = Settings.GetHandle<int>("traparmingtime", "second to recharge. min : 5, max : 999",
