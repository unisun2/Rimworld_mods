...
namespace FP_RSLUM
{
    class PawnColumnWorker_CHA : PawnColumnWorker
    {
        ...
        public override void DoCell(Rect rect, Pawn pawn, PawnTable table)
        {
            ...
            if (pawnlvcomp != null)
            {
                ...
                else
                {
                    ...
                    statCheckbox(topLeft, ref pawnlvcomp.CHAauto, 30f, def.paintable, pawnlvcomp);
                    Rect rect2 = new Rect(rect.x + 35, rect.y, rect.width - 35, Mathf.Min(rect.height, 30f));
                    String textFor = this.GetTextFor(pawn);
                    if (textFor != null)
                    {
        ...
        {
            return "PawnColumnWorker_CHA_Tip_Desc".Translate();
        }
        ...
        protected String GetTextFor(Pawn pawn)
        {
            ...
            if (pawnlvcomp != null)
            {
                return pawnlvcomp.CHA.ToString();
            }
            else
            {
                // WHAT?
        ...
        //    => a.ageTracker.AgeBiologicalYearsFloat.CompareTo(b.ageTracker.AgeBiologicalYearsFloat);
        {
            ...
            {
                return pawnlvcompa.CHA.CompareTo(pawnlvcompb.CHA);
            }
            else
            {
                // WHAT?
