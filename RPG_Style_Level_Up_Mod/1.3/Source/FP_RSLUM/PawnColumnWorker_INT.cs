...
namespace FP_RSLUM
{
    class PawnColumnWorker_INT : PawnColumnWorker
    {
        ...
        //protected override INTing GetTextFor(Pawn pawn)
        //    => Math.Round(pawn.ageTracker.AgeBiologicalYearsFloat, 2).ToINTing("0.00");
        ...
        protected String GetTextFor(Pawn pawn)
        {
            ...
            if (pawnlvcomp != null)
            {
                return pawnlvcomp.INT.ToString();
            }
            else
            {
                // WHAT?
        ...
        //    => a.ageTracker.AgeBiologicalYearsFloat.CompareTo(b.ageTracker.AgeBiologicalYearsFloat);
        {
            ...
            {
                return pawnlvcompa.INT.CompareTo(pawnlvcompb.INT);
            }
            else
            {
                // WHAT?
